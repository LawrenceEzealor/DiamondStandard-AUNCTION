...
contract AUCFacet {
    Auction.AuctionStorage internal l;
    event Approval(
    ...
    function transfer(
        ...
        Auction._transferFrom(msg.sender, _to, _value);
        success = true;
    }
    ...
    function transferFrom(
        ...
        if (msg.sender == _from || l.allowances[_from][msg.sender] >= _value) {
            ...
            Auction._transferFrom(_from, _to, _value);
    ...
    function mintTo(address _user) external {
        ...
        emit Auction.Transfer(address(0), _user, amount);
    }
}